...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "lodash.get", "lodash.set", "mitt", "./key-codes"], factory);
    }
    ...
    var key_codes_1 = __importDefault(require("./key-codes"));
    var _ = {
    ...
    var getDirectionForKeyCode = function (keyCode) {
        var direction = key_codes_1.default.codes[keyCode];
        if (direction) {
    ...
    return /** @class */ (function () {
        function Lrud() {
            ...
            this.emitter = new mitt_1.default();
            this.overrides = {};
        }
        /**
