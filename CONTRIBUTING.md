...
## Reporting Issues
Before opening a new issue, first check that there is not already an [open issue or Pull Request](https://github.com/bbc/taf-service-logan/issues?utf8=%E2%9C%93&q=is%3Aopen) that addresses it.
...
1. Pick an appropriate template for the type of issue [from here](https://github.com/bbc/taf-service-logan/issues/choose)
